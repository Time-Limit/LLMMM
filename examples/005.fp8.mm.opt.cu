...
__global__ void
fp8_gemm_blockwise_quant_A_1x128__B_128x128__C_1x128__output_fp8__double_buffer__no_sm__B_Q_single_buffer(
...
#define launch(function)                                                                                                              \
  ...
  {                                                                                                                                   \
    ...
    if (                                                                                                                              \
      #function                                                                                                                       \
      != std::string(                                                                                                                 \
        "fp8_gemm_blockwise_quant_A_1x128__B_128x128__C_1x128__output_fp8__double_buffer__no_sm__B_Q_single_buffer__memcpy_async")) { \
      sm_size = 0;                                                                                                                    \
    }                                                                                                                                 \
...
launch(fp8_gemm_blockwise_quant_A_1x128__B_128x128__C_1x128__output_fp8__double_buffer__no_sm__B_Q_single_buffer);
...
int main()
{
  ...
  static const int M = 4096, N = 7168, K = 2048;
  ...
  {
    LLMMM::transpose_matrix__aligned_128(d_B_transposed, d_B, K, N, nullptr);
    CHECK_CUDA_ERROR();
  }
...
#define check(function)                                                                                                                                                                    \
  ...
  check(fp8_gemm_blockwise_quant_A_1x128__B_128x128__C_1x128__output_fp8__double_buffer__no_sm__B_Q_single_buffer);
#undef check
